...
python ../jeffs_fred_implementation/jeffs_fred_implementation_protein_prep.py --challengedata 1-get_challenge_data/celpp_weekXX_XXXX --prepdir 2-protein_prep


mkdir 3-ligand_prep
python ../jeffs_fred_implementation/jeffs_fred_implementation_ligand_prep.py --challengedata 1-get_challenge_data/celpp_weekXX_XXXX --prepdir 3-ligand_prep
